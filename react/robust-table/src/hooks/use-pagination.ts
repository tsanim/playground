...
type UsePagination = (total: number, initialPage?: number, initialSize?: number) => PaginationControllers

// TODO: Fix bug with derived state from props
export const usePagination: UsePagination = (total, initialPage = 1, initialSize = 25) => {
    ...
    const setSize = useCallback((payload: number) => dispatch({ type: 'SET_SIZE', payload }), [])
